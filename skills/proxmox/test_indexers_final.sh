...
print("== Test indexer URLs ==")

indexers = [
    {"definitionName": "yts", "name": "YTS", "urls": ["https://yts.lt", "https://yts.am"]},
    {"definitionName": "1337x", "name": "1337x", "urls": ["https://1337x.to", "https://1337x.st"]},
    {"definitionName": "thepiratebay", "name": "The Pirate Bay", "urls": ["https://thepiratebay.org", "https://tpb.party"]}
]
